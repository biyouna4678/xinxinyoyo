...
const replacements = {
  forum: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <mask id="forum-mask">
      <g fill="#ffffff">
  ...
  <rect x="0" y="0" width="100" height="100" mask="url(#forum-mask)" />
</svg>`,
  map: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <rect x="0" y="0" width="100" height="100" mask="url(#map-pin-mask)" />
</svg>`,
  anniversary: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <rect x="0" y="0" width="100" height="100" mask="url(#calendar-mask)" />
  <rect x="29" y="6" width="8" height="20" rx="4" fill="#ffffff" />
  <rect x="63" y="6" width="8" height="20" rx="4" fill="#ffffff" />
</svg>`,
  setting: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <mask id="gear-mask">
      <g fill="#ffffff">
  ...
  <rect x="0" y="0" width="100" height="100" mask="url(#gear-mask)" />
</svg>`,
  music: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <path d="M 25.5,50 C 25.5,23 35,16 50,16 C 65,16 74.5,23 74.5,50 C 69,48 61,23.5 50,23.5 C 39,23.5 31,48 25.5,50 Z" fill="#ffffff" />
  <rect x="20.5" y="49" width="3.5" height="15" rx="1.75" fill="#ffffff" />
  <rect x="76" y="49" width="3.5" height="15" rx="1.75" fill="#ffffff" />
  <rect x="25.5" y="46.5" width="8" height="20" rx="4" fill="#ffffff" />
  <rect x="66.5" y="46.5" width="8" height="20" rx="4" fill="#ffffff" />
  <rect x="48.75" y="44" width="2.5" height="24" rx="1.25" fill="#ffffff" />
  <rect x="44" y="47" width="2.5" height="18" rx="1.25" fill="#ffffff" />
  <rect x="53.5" y="47" width="2.5" height="18" rx="1.25" fill="#ffffff" />
  <rect x="39.25" y="49" width="2.5" height="14" rx="1.25" fill="#ffffff" />
  <rect x="58.25" y="49" width="2.5" height="14" rx="1.25" fill="#ffffff" />
  <rect x="35" y="51.5" width="2" height="9" rx="1" fill="#ffffff" />
  <rect x="63" y="51.5" width="2" height="9" rx="1" fill="#ffffff" />
</svg>`,
  food: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <rect x="0" y="0" width="100" height="100" mask="url(#takeaway-mask)" fill="#ffffff" />
</svg>`,
  shop: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <mask id="cart-mask">
      <g fill="#ffffff">
  ...
  <rect x="0" y="0" width="100" height="100" mask="url(#cart-mask)" fill="#ffffff" />
</svg>`,
  phone: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <mask id="phone-mask">
  ...
  <rect x="0" y="0" width="100" height="100" mask="url(#phone-mask)" fill="#ffffff" />
</svg>`,
  theme: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-label="艺术">
  <path d="M 44.8 17.2 C 29.5 17.2, 16.4 27.0, 12.0 41.4 C 7.0 57.6, 14.6 74.5, 28.7 81.7 C 39.2 87.0, 51.0 85.7, 57.5 78.5 C 61.4 74.1, 62.5 69.3, 59.7 66.0 C 57.3 63.2, 53.0 62.0, 49.8 59.7 C 46.3 57.2, 45.8 53.4, 48.4 50.4 C 50.9 47.5, 55.1 46.0, 57.5 42.7 C 60.6 38.4, 58.8 32.3, 54.5 27.6 C 51.6 24.2, 48.0 20.2, 44.8 17.2 Z" fill="#ffffff" />
  ...
  <path d="M 84.5 11.0 C 82.3 10.0, 80.3 11.4, 78.5 13.2 L 70.0 22.0 C 66.0 26.2, 65.9 32.5, 69.1 36.8 C 72.3 41.0, 78.3 42.0, 82.4 38.7 C 86.6 35.2, 88.0 29.1, 85.0 24.1 C 82.9 20.5, 83.0 16.6, 84.5 11.0 Z" fill="#ffffff" />
  <path d="M 69.0 41.1 L 81.8 42.1 L 80.6 49.7 L 68.3 48.7 Z" fill="#ffffff" />
  <path d="M 68.1 51.0 L 80.5 52.0 L 77.8 80.7 C 77.4 84.7, 74.9 87.2, 71.8 87.0 C 68.4 86.8, 66.3 84.2, 66.7 80.5 Z" fill="#ffffff" />
</svg>`,
  novel: `<svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-label="一起来看小说">
  <path d="M 18 28 L 22 28 L 22 69 C 22 70.4, 23.0 71.2, 24.4 71.0 C 32.8 69.7, 41.5 71.7, 48.0 76.6 L 18 76.6 Z" fill="#ffffff" />
  <path d="M 82 28 L 78 28 L 78 69 C 78 70.4, 77.0 71.2, 75.6 71.0 C 67.2 69.7, 58.5 71.7, 52.0 76.6 L 82 76.6 Z" fill="#ffffff" />
  <path d="M 24.5 21.0 C 34.8 20.7, 43.0 23.2, 48.4 28.0 L 48.4 76.4 C 41.4 71.0, 32.8 68.8, 24.5 70.0 Z" fill="#ffffff" />
  <path d="M 75.5 21.0 C 65.2 20.7, 57.0 23.2, 51.6 28.0 L 51.6 76.4 C 58.6 71.0, 67.2 68.8, 75.5 70.0 Z" fill="#ffffff" />
